...
const BottomSheetGIF = forwardRef(({ height, id, navigation }, ref) => {
  ...
  const saveToGallery = async (lokasi_file, judul_foto) => {
    ...
    try {
      ...
      if (status !== "granted") {
        alert("Izin untuk mengakses galeri diperlukan untuk menyimpan gambar.");
        return;
      }
  ...
  console.log(like, "LIKE RESPONSE PHOTO RAWR");
